      ...
      <div>
        ...
        <Grid celled>
          ...
          <Grid.Column width={11}>
            <TVShowList shows={this.displayShows().filter(show => show.name.toLowerCase().includes(this.state.searchTerm.toLowerCase()))} selectShow={this.selectShow} searchTerm={this.state.searchTerm}/>
          </Grid.Column>
        </Grid>
      </div>
    );
